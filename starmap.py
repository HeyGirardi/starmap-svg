...
parser.add_argument('-cons', nargs='?', help='show constellation True/False', type=bool, default=constellations)
parser.add_argument('-coords', help='coordinates in format northern,eastern', default=coords)
parser.add_argument('-date', help='date in format day.month.year', default=date)
parser.add_argument('-guides', nargs='?', help='draw guides True/False', type=bool, default=guides)
parser.add_argument('-height', nargs='?', help='height in mm', type=int, default=height)
parser.add_argument('-info', help='Info text example eame of the place', default=info)
parser.add_argument('-magn', nargs='?', help='magnitude limit 0.1-12.0', type=float, default=magnitude_limit)
parser.add_argument('-output', help='output filename.svg', default='starmap.svg')
parser.add_argument('-summer', nargs='?', help='if it is summertime on the date of the starchart', type=bool, default=summertime)
parser.add_argument('-time', help='time in format hour.minute.second', default=time)
parser.add_argument('-utc', nargs='?', help='utc of your location -12 to +12', type=int, default=utc)
parser.add_argument('-width', nargs='?', help='width in mm', type=int, default=width)
...
constellations = args.cons
summertime = args.summer
...
northern, eastern = map(float, coords.split(','))
